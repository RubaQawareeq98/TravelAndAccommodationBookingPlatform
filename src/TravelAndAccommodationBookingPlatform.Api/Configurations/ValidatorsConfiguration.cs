...
using TravelAndAccommodationBookingPlatform.Api.RoomCategories.Validators;
...
public static class ValidatorsConfiguration
{
    public static IServiceCollection AddValidatorsConfigurations(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IValidator<UpdateBookingRequest>, UpdateBookingRequestValidator>();
        ...
        services.AddSingleton<IValidator<UpdateRoomCategoryRequest>, UpdateRoomCategoryRequestValidator>();
        services.AddSingleton<IValidator<UpdateRoomCategoryRequest>, UpdateRoomCategoryRequestValidator>();
        services.AddSingleton<IValidator<AddRoomRequest>, AddRoomRequestValidator>();
        services.AddSingleton<IValidator<UpdateRoomRequest>, UpdateRoomRequestValidator>();
        ...
        services.AddSingleton<IValidator<UpdateHotelRequest>, UpdateHotelRequestValidator>();
        services.AddSingleton<IValidator<AddReviewRequest>, AddReviewRequestValidator>();
        services.AddSingleton<IValidator<UpdateReviewRequest>, UpdateReviewRequestValidator>();
