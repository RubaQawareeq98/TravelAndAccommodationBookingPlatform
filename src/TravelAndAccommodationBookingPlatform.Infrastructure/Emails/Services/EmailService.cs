...
public class EmailService(
    ...
    IEmailMessageGeneratorService emailMessageGeneratorService,
    ITransactionalEmailsApi transactionalEmailsApi) : IEmailService
{
    ...
    public async Task SendConfirmationEmail(User user, string hotelName, Booking booking, byte[] invoicePdf)
    {
        ...
        catch (Exception e)
        {
            ...
            throw new InvalidOperationException("Email sending failed", e);
        }
    }
}
